...
void main() async {
  ...
  runApp(SkeletonWindowApp(prefs: prefs));
}

class SkeletonWindowApp extends StatelessWidget {
  final SharedPreferences prefs;

  const SkeletonWindowApp({super.key, required this.prefs});

  @override
  Widget build(BuildContext context) {
    // Configure window identity — replace with your window type's values.
    final identity = WindowIdentity(
      typeId: 'skeleton',
      typeColor: const Color(0xFF6B7280), // neutral placeholder
      label: 'Skeleton Window',
    );
