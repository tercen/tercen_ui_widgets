...
class WindowStateProvider extends ChangeNotifier {
  ...
  void requestMaximize() => _publishIntent(WindowChannels.typeMaximize);

  /// Request the frame to restore this window from maximized.
  void requestRestore() => _publishIntent(WindowChannels.typeRestore);
  ...
  void requestOpenResource({
    ...
    _publishIntent(WindowChannels.typeOpenResource, {
  ...
  void updateLabel(String newLabel) {
    ...
    notifyListeners();
    _publishIntent(WindowChannels.typeContentChanged, {'label': newLabel});
  }
