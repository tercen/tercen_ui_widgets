...
///
/// Uses NavigatorProvider directly instead of the generic WindowStateProvider.
  ...
  Widget build(BuildContext context) {
    ...
    switch (provider.contentState) {
      case ContentState.loading:
        return const LoadingState(message: 'Loading projects...');
      ...
      case ContentState.error:
        return ErrorState(
          ...
          onRetry: onRetry ?? () => provider.loadTree(),
        );
    }
  }
}
