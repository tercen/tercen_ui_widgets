...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1550: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1551: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _2670: (x0,x1) => { x0.accept = x1 },
      _2686: x0 => x0.files,
      _2728: (x0,x1) => { x0.type = x1 },
      _3375: () => globalThis.window,
      _3710: x0 => x0.localStorage,
      _4143: x0 => x0.length,
      _8245: () => globalThis.document,
      _9333: x0 => x0.name,
      _9339: x0 => x0.length,
