      ...
      child: Column(
        ...
        children: [
          ...
          _MenuItem(
            ...
            hoverColor: hoverColor,
            onTap: () {
              provider.openLlmSettings();
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('LLM Settings opened')),
              );
              onDismiss?.call();
            },
          ),
          ...
          _MenuItem(
            ...
            hoverColor: hoverColor,
            onTap: () {
              provider.openTaskManager();
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Task Manager opened')),
              );
              onDismiss?.call();
            },
          ),
          ...
          if (provider.userState.isAdmin) ...[
            ...
            _MenuItem(
              ...
              hoverColor: hoverColor,
              onTap: () {
              provider.openAdminPanel();
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Admin Panel opened')),
              );
              onDismiss?.call();
            },
            ),
